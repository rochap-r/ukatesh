...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-00VGFP8ZK5"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-00VGFP8ZK5');
    </script>
    ...
    <title>@yield('title',siteInfos()->sitename) </title>
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="copy">
                            <p>Copyright &copy; <span id="year"></span>
                                <a href="." class="link-secondary"><b>{{ siteInfos()->sigle }}</b></a>.
