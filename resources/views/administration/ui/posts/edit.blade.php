...
@section('title',"Edition de l'article : ".$post->title)
@push('style')
    {{-- CSS complementaires --}}
@endpush
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.posts.update',$post) }}" id="editPost" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-9">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="form-title" name="title" placeholder="Saisissez le titre d'article" value="{{ $post->title }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="image_holder mb-2" style="max-width: 250px;">
                            <img src="" alt="" class="img-thumbnail" id="image-previewer" data-ijabo-default-img="{{ $post->image?
                        ...
                        <div class="mb-3">
                            <div>
                                <label class="row">
                                    <span class="col {{ $post->approved ? 'text-success':'text-danger' }}">{{ $post->approved ? 'Approuvé':'Non Approuvé' }}</span>
                                    <span class="col-auto">
                                       <label class="form-check form-check-single form-switch">
                                         <input class="form-check-input" {{ $post->approved ? 'checked':'' }} type="checkbox" name="approved">
                        ...
                        <button type="submit" class="btn btn-info text-uppercase"> enregistrer les modifications</button>
                    </div>
                </div>
            </div>
        </div>
