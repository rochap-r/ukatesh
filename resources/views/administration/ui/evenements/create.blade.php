    ...
    @section('content')
        ...
        <form method="POST" action="{{ route('admin.evenements.add') }}" id="addEvent" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="form-lieu" name="lieu" placeholder="Pas obligatoire">
                            </div>
                            <div class="mb-3">
                                <div class="form-email">Adresse email</div>
                                <input type="text" class="form-control" id="form-email" name="email" placeholder="Pas obligatoire">
                            </div>
                            <div class="mb-3">
                                <div class="form-tel">Tel événement</div>
                                <input type="text" class="form-control" id="form-tel" name="tel" placeholder="Pas obligatoire">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Date</label>
                                <input class="form-control mb-2" name="dat_event" placeholder="Select a date" id="datepicker-default" value="">
                            </div>
                            <div class="mb-3">
