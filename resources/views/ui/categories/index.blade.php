...
@section('title','Actualités de la catégorie: '.$categorie->name)
@section('meta')
    <!--balise meta ici-->
    ...
    <div class="container" style="margin-bottom: 40%;">
        ...
        <div class="latest-news-area pt-100 pb-70" >
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="latest-news-left-content pr-20" style="background-image:url({{ asset('storage/posts/'.$lastPost->image->name) }}); height:450px;">
                            <div class="latest-news-simple-card">
                                <div class="news-content">
                                    <div class="list">
                                        <ul>
                                            <li><i class="flaticon-user"></i>Par <a href="javascript:void(0)">{{ $lastPost->author->name }}</a></li>
                                            <li><i class="flaticon-tag"></i><a href="{{ route('category.index',$lastPost->category) }}">{{ $lastPost->category->name }}</a></li>
                                        </ul>
                                    </div>
                                    <a href="{{ route('blog.show',$lastPost) }}"><h3>{{ $lastPost->title }}</h3></a>
                                    <a href="{{ route('blog.show',$lastPost) }}" class="read-more-btn active">Lire plus...<i class="flaticon-next"></i></a>
                                </div>
                            </div>
